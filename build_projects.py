...
PROJECTS = [
    ...
    {
        "slug": "yuval",
        "title": "גינת קרקע ברמת אביב",
        "seo_title": "גינת קרקע לבית פרטי ברמת אביב | גן פרא",
        "meta": "גינת קרקע · רמת אביב",
        "cat": "houses",
        "span2": True,
    ...
    {
        "slug": "nine-cloud",
        "title": "משרדי ניין קלאוד",
        "seo_title": "עיצוב והצמחת משרדים במגדל, תל אביב | גן פרא",
        "meta": "משרדים · תל אביב",
        "cat": "offices",
        "span2": False,
        "short": "צמחייה שמרככת קומת משרדים במגדל: אדניות בטון לאורך החלונות, ירוק בחדרי הישיבות ומטפסים במטבחון.",
        "story": [
            ("הפרויקט", "קומת משרדים במגדל בתל אביב, עם חזית זכוכית ונוף עירוני פתוח. המטרה הייתה לרכך חלל עבודה של בטון, זכוכית ומתכת בלי לחסום את הנוף ובלי להעמיס על הצוות תחזוקה יומית."),
            ("מה הקמנו", "אדניות בטון וכדים כהים בנקודות המפתח: דלפק הקבלה, חדרי הישיבות, קו החלונות והמטבחון. הכלים נבחרו בגוונים של החלל עצמו כדי שהצמח יהיה מה שבולט."),
            ("הצמחייה", "פיקוס וסנסוויאריה שעומדים באור עקיף ובמיזוג, ומטפסים משתלשלים מארונות המטבחון. הכול נבחר לעמידות בתנאי משרד — אור מסונן, אוויר יבש והשקיה שבועית."),
        ],
        "facts": ["קומת משרדים", "אדניות בטון", "צמחייה לתנאי מיזוג", "תחזוקה שבועית"],
        "hero_alt": "חדר ישיבות במגדל: פיקוס בכד בטון לצד שולחן הישיבות",
        "gallery_alts": [
            "דלפק הקבלה עם אדניות סנסוויאריה על רצפת דגם אשור",
            "פיקוס מול קיר הבטון בחדר הישיבות",
            "צמחייה משתלשלת מארונות המטבחון",
            "אדניות לאורך חלון הפינה מול מגדלי העיר",
            "צמח לצד עמוד הבטון, עם נוף העיר מהחלון",
        ],
    },
    {
