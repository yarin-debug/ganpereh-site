...
# ⚠️ ארבע קטגוריות, לפי המיון שירין עשה בספריית הצילומים עצמה — הוא
# מכיר את העבודות ואת הלקוחות, והמיון שלו גובר על החלוקה הישנה בת
# חמש. "בנייני מגורים" ירדה: ויצמן ובן שפרוט מתויקים אצלו תחת קרקע
# ועסקים, וקינג ג'ורג' תחת מרפסות.
CATS = {
    "karka": "גינות קרקע",
    "roof": "מרפסות וגגות",
    "offices": "משרדים",
...
def cats_of(p):
    """הקטגוריות של פרויקט. הראשונה היא זו שמוצגת כתווית.

    ⚠️ פרויקט יכול להשתייך ליותר מאחת, וזה לא מקרה קצה: בקינג ג'ורג'
    יש לובי, דירת גן, מרפסות ופנטהאוז, והוא גם מלון דירות — כלומר הוא
    רלוונטי ללקוח מרפסת, ללקוח גינת קרקע ולבעל עסק כאחד. בספריית
    הצילומים הוא מתויק בשתי קטגוריות בפועל.
    """
    return [p["cat"], *p.get("also", [])]
...
PROJECTS = [
    {
        "slug": "shoham-garden",
        "title": "שיפוץ גן בוגר בשוהם",
        "seo_title": "שיפוץ גינת קרקע בשוהם | גן פרא",
        "meta": "גינת קרקע · שוהם",
        "cat": "karka",
        "short": "גן בוגר שעבר שיפוץ מלא: הדשא הוחלף כולו, מה שלא שרד נעקר, ומה שנשאר קיבל טיפול אגרונומי. אחריו שתילה מחודשת ומערכת השקיה חדשה.",
        "story": [
            ("הפרויקט", "גינת קרקע בשוהם, בבית שכבר היה בו גן בוגר. הבקשה לא הייתה ריענון אלא שיפוץ מלא: להכריע מה נשאר, להוציא את מה שלא, ולבנות מחדש את הדשא, ההשקיה והשתילה."),
            ("מה הקמנו", "הדשא הוחלף במלואו. עצים ושיחים שלא שרדו נעקרו ופונו, ומה שנשאר עבר טיפול וגיזום אגרונומי שהחזיר לו צורה — זה החלק שקובע אם גן בוגר נראה מטופל או מוזנח. מערכת ההשקיה הוקמה מחדש מהיסוד: פריסת צנרת מלאה, מדשנת וכל אביזרי המערכת."),
            ("הצמחייה", "שתילה מחודשת ומאסיבית סביב העצים הבוגרים ששרדו. דקלים, בוגנוויליה ושיחים ממלאים את גבולות החצר וסוגרים אותה, ובמרכז נשארה המדשאה הפתוחה."),
        ],
        "facts": ["שיפוץ מלא", "החלפת דשא מלאה", "טיפול וגיזום אגרונומי", "מערכת השקיה חדשה עם מדשנת"],
    },

    {
        "slug": "baruch-agadati",
        "title": "חצר בית פרטי בברוך אגדתי",
        "seo_title": "שיפוץ גינת קרקע ברחוב ברוך אגדתי, תל אביב | גן פרא",
        "meta": "גינת קרקע · תל אביב",
        "cat": "karka",
        "short": "משפחה שעברה מהרי ירושלים לתל אביב, וביקשה שהגינה תחזיר להם את פיסת הטבע שהייתה להם שם. דשא סינתטי הוחלף בדשא אמיתי, והעצים הבוגרים טופלו ושוקמו.",
        "story": [
            ("הפרויקט", "חצר בית פרטי ברחוב ברוך אגדתי בתל אביב, עם כניסה שיש בה ערוגות שתילה באדמה וחצר אחורית. המשפחה נכנסה לגור בבית אחרי שעברה מאזור הרי ירושלים, וביקשה גינה שתחזיר להם את פיסת הטבע שהייתה להם שם. העצים הבוגרים כבר היו בחצר, והם היו נקודת המוצא."),
            ("מה הקמנו", "התחלנו בטיפול ושיקום של כל העצים הקיימים: גיזום, עיצוב, ועקירה ופינוי של מה שלא שרד. הדשא הסינתטי הוצא, ובמקומו דשא אלטורו אמיתי בשטח 30 מ״ר עם כל הכנות התשתית, ושביל אבני מדרך באורך 2.5 מטר שחוצה אותו. מערכת ההשקיה הוקמה מחדש קומפלט: ראש מערכת בן ארבע הפעלות עם מדשנת בארון, פריסת צנרת מלאה, טפטוף לערוגות וקווי מתזים למדשאה."),
            ("הצמחייה", "קוב מצע שתילה וקוב קומפוסט נכנסו לקרקע לפני השתילה. מעליהם מאתיים סיגליות משתרעות שסוגרות את פני הקרקע, וארבעים שיחים בינוניים בשני גדלים, בכניסה ובחצר האחורית כאחת. הכול נבחר לצמיחה שנשפכת ומתפשטת, כדי שהחצר תיראה טבעית ולא מסודרת."),
        ],
        "facts": ["מהרי ירושלים לתל אביב", "סינתטי הוחלף בדשא אמיתי", "שיקום העצים הבוגרים", "מערכת השקיה חדשה קומפלט"],
    },


    {
        "slug": "alexander-pen",
        "title": "שלוש מרפסות בפנטהאוז באלכסנדר פן",
        "seo_title": "עיצוב מרפסות פנטהאוז ברחוב אלכסנדר פן, תל אביב | גן פרא",
        "meta": "פנטהאוז · תל אביב",
        "cat": "roof",
        "short": "פנטהאוז עם שלוש מרפסות, ומרפסת שירות שנעלמה כולה מאחורי מטפסים. עץ זית פיסולי בקדמית, מרווה בגבהים משתנים, וקזוארינה שנשפכת מהכלי כחצאית ירוקה.",
        "story": [
            ("הפרויקט", "פנטהאוז ברחוב אלכסנדר פן בתל אביב, ובו שלוש מרפסות: קדמית בת 20 מ״ר, אחורית בת 12 ומרפסת שירות קטנה של 5. הבקשה הייתה פרטיות, גינת תבלינים, ופתרון שמנצל כל מטר לפי התנאים של כל מרפסת בנפרד."),
            ("מה הקמנו", "שלוש אדניות מתכת נבנו בהתאמה אישית לקו המעקה, הארוכה שבהן 380 ס״מ, ולצידן חמש אדניות בטון קל ושלושה כדים. מרפסת השירות הוסתרה במלואה: קונסטרוקציה שנבנתה במקום, ועליה מטפסים שסוגרים אותה לגמרי. מערכת ההשקיה יושבת בארון עם ראש מערכת, מחשב, מדשנת ומסנן, וממנה צנרת טפטוף וניקוז לכל אדנית. מיכל דשן נוזלי מחובר למדשנת, כך שההזנה רצה עם ההשקיה."),
            ("הצמחייה", "במרפסת הקדמית עץ זית פיסולי כעוגן, וסביבו צמחייה משתרעת ונשפכת ששוברת את קו האדנית ובונה כמה מישורי גובה. שיחי מרווה בגבהים שונים מוסיפים פריחות ייחודיות, ויסמין מטפס על העמודים וסוגר את המבט מהשכנים. באחורית פיטנות ומגנוליות, ולמרגלותיהן קזוארינה שממלאת את הכלי ונשפכת ממנו כחצאית ירוקה."),
        ],
        "facts": ["שלוש מרפסות · 37 מ״ר", "מרפסת שירות שהוסתרה לגמרי", "עץ זית פיסולי", "השקיה ממוחשבת עם מדשנת"],
    },
    {
        "slug": "ruth-ramat-gan",
        "title": "מרפסת בקומה שביעית ברמת גן",
        "seo_title": "עיצוב מרפסת בבניין מגורים ברמת גן | גן פרא",
        "meta": "מרפסת · רמת גן",
        "cat": "roof",
        "short": "זוג מעצבים ביקשו ניצול מרבי של המרחב, תחזוקה מינימלית וצבעים עדינים. אדנית ברזל טרפזית באורך 4.4 מטר שהורמה במנוף, ומללויקה בכותי בתוכה.",
        "story": [
            ("הפרויקט", "מרפסת בקומה השביעית של בניין מגורים ברמת גן. הצילומים מראים את המצב שקיבלנו: ריצוף, מעקה, ואפס צמחייה. הלקוחות זוג מעצבים, ולכן הבקשה הייתה ניצול מרבי של המרחב, תחזוקה מינימלית וצבעים עדינים."),
            ("מה הקמנו", "אדנית ברזל מגולוון בעובי 2 מ״מ נבנתה לאורך המעקה, 436 ס״מ, וברוחב שמשתנה מ-65 ס״מ ל-15. היא מתרחבת במקום שבו יושבים ומצטמצמת במקום שבו עוברים, וכך כל סנטימטר של המרפסת נשאר בשימוש. לצידה שמונה אדניות נוספות. הכול הורם במנוף לקומה השביעית, ובארון הותקנו שני ראשי מערכת מדושנים עם צנרת הולכה וטפטוף לכל אדנית."),
            ("הצמחייה", "מללויקה ארג׳נטה בכותי כעוגן, עץ בעל עלווה כסופה ונופלת. סביבה שבעים שתילים בפלטה מצומצמת ועדינה, בחמישה קוב מצע שתילה קל. המראה מינימליסטי, והצמחייה בכל זאת נשארת פראית בדרכה."),
        ],
        "facts": ["מרפסת בקומה 7", "אדנית טרפזית באורך 4.4 מ׳", "הרמה במנוף", "מללויקה ארג׳נטה בכותי"],
    },
    {
        "slug": "myki-store",
        "title": "חזית חנות אופנה ביהודה הלוי",
        "seo_title": "גינון לחזית חנות ברחוב יהודה הלוי, תל אביב | גן פרא",
        "meta": "חזית עסק · תל אביב",
        "cat": "asakim",
        "short": "חזית חנות שיצאה משליטה וחסמה את הכניסה. איפוס תשתיות, שתילה משלימה, ומאז ביקור חודשי קבוע ששומר עליה פתוחה ומזמינה.",
        "story": [
            ("הפרויקט", "חזית של חנות אופנה ברחוב יהודה הלוי בתל אביב. הצמחייה הייתה שם, ובמשך חודשים לא טופלה. היא יצאה משליטה, חסמה את המעבר, והפריעה גם ללקוחות החנות וגם לדיירי הבניין שמעליה. כניסה שאמורה להזמין פנימה הפכה לכניסה חסומה."),
            ("מה עשינו", "התחלנו באיפוס: גיזום מקצועי, עקירת צמחים מתים, הוספת מצע שתילה לכל המיכלים ודישון יסודי. אחר כך שלושה מיכלי שתילה גדולים חדשים, שתילה משלימה בתוך המיכלים הקיימים, ועץ אחד שהחזיר לחזית את הגובה שאבד לה."),
            ("ומה שממשיך", "מאז החזית נמצאת בתוכנית תחזוקה: ביקור חודשי קבוע, מעקב אחר בריאות הצמחים, טיפול במזיקים ודישון שמותאם לעונה. שתילה עונתית נכנסת במחירי עלות, כך שהחזית מתחדשת בלי שיחה על מחיר בכל פעם."),
        ],
        "facts": ["רענון גינה קיימת", "3 מיכלי שתילה חדשים", "ביקור חודשי קבוע", "לקוח תחזוקה פעיל"],
    },
    ...
    {
        "slug": "ramat-hahayal",
        "title": "חצר עם עץ מנגו ברמת החייל",
...
def build_archive(nav, footer):
    ...
    for p in PROJECTS:
        ...
        if p["slug"] in FEATURED:
            span += " span2"
        # ⚠️ הכיתוב נקרא מה-manifest ולא מהרשומה. עד היום הוא נקרא מהרשומה
        # בלבד, ולכן החלפת תמונת ההירו בתיקיית המקור השאירה בכרטיס תיאור
        # של צילום שכבר לא קיים — בלי שום שגיאה, ודווקא בטקסט שקורא המסך
        # מקריא. הרשומה נשארת כרשת ביטחון לפרויקט בלי תיקיית מקור.
        cover_alt = (mf or {}).get("cover_alt") or p.get("hero_alt", p["title"])
        cards.append(f"""    <div class="pj-card{span}" data-cat="{' '.join(cats_of(p))}" tabindex="0" role="button"
...
def build_project(p, prev_p, next_p, nav, footer):
    ...
    hero_alt = (mf or {}).get("hero_alt") or p.get("hero_alt", p["title"])
...
<section class="pjd-hero {hero_layout}">
  <picture>
    ...
    <img src="{base}/hero.webp" alt="{hero_alt}" fetchpriority="high"{dims(f"{base}/hero.webp")} />
  </picture>
