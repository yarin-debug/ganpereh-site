...
export function render(step, ctx) {
  ...
  root.append(
    ...
    /* ⚠️ אין כאן צ׳קבוקס הסכמה לדיוור, בכוונה — ובניגוד לשני טופסי
       האתר. השורה הזו מבטיחה "בלי רשימות תפוצה", וסימון הסכמה לדיוור
       מתחתיה היה סותר אותה באותו מסך. ההבטחה היא גם העמדה המשפטית
       החזקה יותר: מי שלא מדוור אינו צריך הסכמה לדיוור.
       🔴 ולכן היא גם מחייבת: אם ייפתח ניוזלטר, אי-אפשר לכלול בו את מי
       שנרשם דרך השאלון בלי לבקש ממנו הסכמה בנפרד. */
    el(
      "p",
      { class: "q-trust" },
      "נחזור אליכם אישית. בלי ספאם ובלי רשימות תפוצה. ",
      el("a", { href: "/privacy.html", target: "_blank", rel: "noopener" }, "מה קורה עם הפרטים"),
    ),
  );
  return root;
}
